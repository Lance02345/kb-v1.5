                ...
                <table role="presentation" width="620" cellspacing="0" cellpadding="0" style="width:100%;max-width:620px;background:#0f172a;border-radius:12px;overflow:hidden;border:1px solid #334155;box-shadow:0 16px 34px rgba(2,6,23,.45);">
                    ...
                    <tr>
                        <td style="padding:0 20px 24px;">
                            <a href="{{ url('/reset-password/' . $token . (!empty($email) ? ('?email=' . urlencode($email)) : '')) }}" style="display:inline-block;background:linear-gradient(120deg,#fbbf24,#fcd34d);color:#111827;text-decoration:none;font-weight:700;font-size:14px;padding:11px 16px;border-radius:8px;">Reset Password</a>
                        </td>
                    </tr>
                    <tr>
