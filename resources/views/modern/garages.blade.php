            ...
            @foreach($garages as $garage)
                <article class="overflow-hidden rounded-2xl border border-slate-800 bg-slate-900">
                    <a href="{{ route('garage.show', $garage->id) }}">
                        <img src="{{ !empty($garage->front_img) ? asset('storage/' . ltrim($garage->front_img, '/')) : asset('images/land1.jpg') }}" alt="{{ $garage->garage_title }}" class="aspect-[4/3] w-full object-cover">
                    </a>
